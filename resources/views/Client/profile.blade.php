    ...
    <main class="main-content">
        ...
        <section class="profile-section">
            ...
            <div class="profile-header">
                <img src="https://ui-avatars.com/api/?name={{ $user->name }}&background=ffffff&color=2563eb&size=120"
                     alt="Profile Picture"
                     class="profile-avatar-large">

                <div class="profile-header-info">
                    <h1>{{ $user->name }}</h1>
                    <span class="profile-role-badge">👤 Client</span>
                        ...
                        <div class="info-details">
                            ...
                            <div class="info-value">
                                @if($client->last_activity)
                                    {{ \Carbon\Carbon::parse($client->last_activity)->diffForHumans() }}
        ...
        <div class="modal-overlay" id="editModal">
            <div class="modal-content">
                ...
                <form action="{{ route('client_profile.update') }}" method="POST">
                    @csrf
                    @method('PUT')
        ...
        <div class="modal-overlay" id="passwordModal">
            <div class="modal-content">
                ...
                <form action="{{ route('client_profile.updatePassword') }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="form-group">
