    ...
    <style>
        * {
        ...
        .tech-register-btn {
            ...
            gap: 10px;
            padding: 14px 35px;
            background: linear-gradient(135deg, #058c96 0%, #10b981 100%);
            color: white;
            border: none;
            border-radius: 12px;
            font-size: 15px;
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="tech-register">
            ...
            <a href="{{ route("register") }}" class="tech-register-btn">
                <span>🔧</span>
